...
const NewTool = class NewTool extends Tool {
  ...
  onMouseMovement = (event) => {
    ...
    elements[2].plot(elements[0].x() + calculatedWidth, elements[0].y(), elements[0].x(), elements[0].y() + calculatedHeight);
  ...
  drawElement = () => {
    let element = SVGArea.getImage().rect(1, 1).move(this.startX, this.startY + 5)
